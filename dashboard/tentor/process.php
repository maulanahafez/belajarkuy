...
?>
<?php
$username = $password = $nama_user = $email_user = $no_telp_user = '';
$tipe_user = "tentor";
$err = 0;
...
if (isset($_GET['edit'])) {
  ...
  if (isset($_POST['edit'])) {
    ...
    $email_user = $_POST['email_user'];
    $no_telp_user = $_POST['no_telp_user'];
    $sql2 = "update user set password = '$password', nama_user = '$nama_user', email_user = '$email_user', no_telp_user = '$no_telp_user' where username = '$id'";
    $q2 = mysqli_query($conn, $sql2);
    if ($q2) {
    ?>
      <script>
